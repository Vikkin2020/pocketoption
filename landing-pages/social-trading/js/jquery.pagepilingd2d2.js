...
(function ($, document, window, undefined) {
    ...
    $.fn.pagepiling = function (custom) {
        ...
        window.onload = function () {
            let navListArr = document.querySelectorAll('#pp-nav ul li');
            if (navListArr.length > 0) {
                navListArr.forEach(navList => {
                    var tooltip = navList.getAttribute('data-tooltip');
                    $(navList).append('<div class="pp-tooltip right">' + tooltip + '</div>')
                });
